...
public class ServicioCrearVehiculo {
    ...
    private static final String EL_VEHICULO_YA_EXISTE_EN_EL_SISTEMA = "El usuario ya existe en el sistema";
    ...
    private void validarExistenciaPrevia(Vehiculo vehiculo) {
        boolean existe = this.repositorioVehiculo.existe(vehiculo.getId());
        if(existe) {
